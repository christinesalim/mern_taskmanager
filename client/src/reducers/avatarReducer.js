...
const AvatarReducer = ( state = INITIAL_STATE, action) => {
    ...
    switch(action.type) {
      case UPLOAD_AVATAR_REQ_RECEIVED:
        ...
        return{ ...state, fileName: action.payload, fileUploaded: false, error: null };
      case UPLOAD_AVATAR_COMPLETED:
        console.log("UPLOAD_AVATAR_COMPLETED reducer ");
        return { ...state, fileUploaded: true, uploadStatus: action.payload, error: null };
      ...
      case DELETED_AVATAR_FILE:
        return { ...state, fileName: null, file: null, fileUploaded: false, deleteStatus: action.playload, error: null  };
      default:
        return state;
    }
};
